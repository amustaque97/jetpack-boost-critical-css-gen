...
/**
 * CancelledError - Thrown when the process is cancelled by a callback.
 */
class CancelledError extends CriticalCssError {
	constructor() {
...
const CriticalCssErrorTypes = {
	...
	// Special case; thrown when the process is abandoned.
	CancelledError,
